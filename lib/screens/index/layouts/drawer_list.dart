...
padding: EdgeInsets.symmetric(horizontal: Responsive.isDesktop(context) && value == false
    ? 0: Insets.i15,vertical: Insets.i5),
                ...
                color:  Responsive.isDesktop(context) && value == false
                    ? appCtrl.appTheme.secondary: indexCtrl.selectedIndex == e.key
