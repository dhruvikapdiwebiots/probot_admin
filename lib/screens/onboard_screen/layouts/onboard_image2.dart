    ...
    return GetBuilder<OnboardController>(builder: (onboardCtrl) {
      return Stack(alignment: Alignment.centerLeft, children: [
        ...
        image!.isNotEmpty &&
            ...
            ? CommonDottedBorder(
                    child: Image.memory(onboardCtrl.onboardWebImage2, fit: BoxFit.fill,height: Sizes.s150,width: Sizes.s150))
                .inkWell(
                    ...
                    : CommonDottedBorder(
                        ...
                        .inkWell(
                            onTap: () => onboardCtrl.getImage(
                                ...
                                context: context,
                                title: "image2"))
      ]).height(onboardCtrl.isOnboardUploadFile2 ? Sizes.s150  :  image!.isNotEmpty ?Sizes.s150 :Sizes.s50);
    });
  }
}
